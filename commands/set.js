...
Possible arguments: \`announcemessage <message>\`, \`announcechannel <#channel>\`, \`dqpingchannel <#channel>\`, \`pingrole <@role>\`, \`timezone <city>\`, \`language <language in ISO-639-1 code>\``);
      } else {
...
Currently supported cities: \`America/Los_Angeles\`, \`America/Phoenix\`, \`America/Denver\`, \`America/Regina\`, \`America/Chicago\`, \`America/New_York\`, \`Pacific/Honolulu\``)
          ...
          case 'language':
            if (setArgs.length === 2) {
              ...
              } else { sendMessage(message, 'I could not find or do not support the language provided :sob: . Make sure the language specified is in shorthand format (ISO-639-1 code). Check this to see which languages/codes are supported: https://cloud.google.com/translate/docs/languages.'); }
            } else if (setArgs.length === 1) {
